...
from ps2 import load_map, find_optimal_path, find_optimal_path_no_traffic, find_optimal_path_in_traffic_no_toll, find_optimal_path_restricted
import unittest
...
class InternalPs2Test(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.r4 = DirectedRoad(cls.n2, cls.n4, 3.5, 'hill', 1.0)

        cls.m.insert_road(cls.r1)
        cls.m.insert_road(cls.r2)
        cls.m.insert_road(cls.r3)
        cls.road_map = load_map(ROADMAP_FILENAME)
        cls.small_map = load_map(SMALLMAP_FILENAME)
    ...
    def test_2_load_map(self):
        self.assertIsInstance(self.road_map, RoadMap, f"Your load_map() should have returned an instance of RoadMap, but instead returned an instance of {type(self.road_map)}.")
        ...
        for road in all_roads:
            ...
            if road_type != 'hill':
                ...
                possible_other_way_road_1 = DirectedRoad(road_end, road_start, road_travel_time*2, road_type, road_traffic_multiplier)
                possible_other_way_road_2 = DirectedRoad(road_end, road_start, road_travel_time*1/2, road_type, road_traffic_multiplier)
        ...
        expected_roads = {
            ...
            DirectedRoad(node6, node7, 7.0, ARTERIAL, 2.0),
            DirectedRoad(node7, node6, 7.0, ARTERIAL, 2.0),
            DirectedRoad(node7, node8, 2.0, HIGHWAY, 5.0),
            DirectedRoad(node8, node7, 2.0, HIGHWAY, 5.0),
            DirectedRoad(node8, node9, 10.0, ARTERIAL, 2.0),
            DirectedRoad(node9, node8, 10.0, ARTERIAL, 2.0),
    ...
    def test_4a_find_optimal_path_no_traffic(self):
        start, end = Node('N0'), Node('N9')
        expected_path = [Node('N0'), Node('N2'), Node('N3'), Node('N6'), Node('N7'), Node('N9')]
        student_path = find_optimal_path_no_traffic(ROADMAP_FILENAME, start, end)
        self.assertEqual(list, type(student_path), "Make sure you are returning the correct type")
        self.assertEqual(expected_path, student_path, "Make sure your find_optimal_path_no_traffic is correct")

    def test_4b_find_optimal_path_restricted_avoid_local(self):
        start, end = Node('N3'), Node('N6')
        expected_path = [Node('N3'), Node('N8'), Node('N7'), Node('N6')]
        student_path = find_optimal_path_restricted(ROADMAP_FILENAME, start, end)
        self.assertEqual(list, type(student_path), "Make sure you are returning the correct type")
        self.assertEqual(expected_path, student_path, "Make sure your find_optimal_path_restricted is correct")

    def test_4b_find_optimal_path_restricted_avoid_hill(self):
    ...
    def test_4b_find_optimal_path_restricted_avoid_both_local_hill(self):
    ...
    def test_4c_find_optimal_path_in_traffic_no_toll(self):
        start, end = Node('N0'), Node('N9')
        expected_path = [Node('N0'), Node('N2'), Node('N3'), Node('N8'), Node('N9')]
        student_path = find_optimal_path_in_traffic_no_toll(ROADMAP_FILENAME, start, end)
        self.assertEqual(list, type(student_path), "Make sure you are returning the correct type")
        self.assertEqual(expected_path, student_path, "Make sure your find_optimal_path_in_traffic is correct")
